...
void CheckPerformance(){
	...
	TString infiles = {"/Users/zhaozhongshi/Desktop/TempDownload/SiTPCMatchFiles/SeedAna_Svtx_New.root"};
	...
	for(int i = 0; i < NEvent; i++){
		...
		cout << "Event: " << i  << "   Total TPC Seeds:  " << tpcseedsize << " SvtxMatched - NTracks:  My Cut:  " << NTrackAfterCut << "   Official Joe Cut:  " << svtxsiseedsize << endl;
