...
//	SeedAna->SetBranchAddress("event",&event);
	...
	Inc->GetYaxis()->SetTitle("Fraction of TPC Seeds");
	Inc->GetXaxis()->CenterTitle();
	Inc->GetYaxis()->CenterTitle();
	Inc->GetYaxis()->SetTitleOffset(1.9);
	...
	IncLaser->GetYaxis()->SetTitle("Fraction of TPC Seeds");
	IncLaser->GetXaxis()->CenterTitle();
	IncLaser->GetYaxis()->CenterTitle();
	IncLaser->GetYaxis()->SetTitleOffset(1.9);
	...
	IncNoLaser->GetYaxis()->SetTitle("Fraction of TPC Seeds");
	IncNoLaser->GetXaxis()->CenterTitle();
	IncNoLaser->GetYaxis()->CenterTitle();
	IncNoLaser->GetYaxis()->SetTitleOffset(1.9);
	...
	IncX->GetYaxis()->SetTitle("Fraction of TPC Seeds");
	IncX->GetXaxis()->CenterTitle();
	IncX->GetYaxis()->CenterTitle();
	IncX->GetYaxis()->SetTitleOffset(1.9);
	...
	IncLaserX->GetYaxis()->SetTitle("Fraction of TPC Seeds");
	IncLaserX->GetXaxis()->CenterTitle();
	IncLaserX->GetYaxis()->CenterTitle();
	IncLaserX->GetYaxis()->SetTitleOffset(1.9);
	...
	IncNoLaserX->GetYaxis()->SetTitle("Fraction of TPC Seeds");
	IncNoLaserX->GetXaxis()->CenterTitle();
	IncNoLaserX->GetYaxis()->CenterTitle();
	IncNoLaserX->GetYaxis()->SetTitleOffset(1.9);
	...
	IncY->GetYaxis()->SetTitle("Fraction of TPC Seeds");
	IncY->GetXaxis()->CenterTitle();
	IncY->GetYaxis()->CenterTitle();
	IncY->GetYaxis()->SetTitleOffset(1.9);
	...
	IncLaserY->GetYaxis()->SetTitle("Fraction of TPC Seeds");
	IncLaserY->GetXaxis()->CenterTitle();
	IncLaserY->GetYaxis()->CenterTitle();
	IncLaserY->GetYaxis()->SetTitleOffset(1.9);
	...
	IncNoLaserY->GetYaxis()->SetTitle("Fraction of TPC Seeds");
	IncNoLaserY->GetXaxis()->CenterTitle();
	IncNoLaserY->GetYaxis()->CenterTitle();
	IncNoLaserY->GetYaxis()->SetTitleOffset(1.9);
	...
	Inc->Scale(1.0/Inc->Integral());
	IncLaser->Scale(1.0/IncLaser->Integral());
	IncNoLaser->Scale(1.0/IncNoLaser->Integral());
	...
	IncX->Scale(1.0/IncX->Integral());
	IncLaserX->Scale(1.0/IncLaserX->Integral());
	IncNoLaserX->Scale(1.0/IncNoLaserX->Integral());

	IncX->SetMaximum(0.05);
	IncX->Draw("hist");
	...
	IncY->Scale(1.0/IncY->Integral());
	IncLaserY->Scale(1.0/IncLaserY->Integral());
	IncNoLaserY->Scale(1.0/IncNoLaserY->Integral());

	IncY->SetMaximum(0.05);
