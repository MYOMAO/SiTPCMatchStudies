...
ls *root
mv  track_match.root  /direct/sphenix+tg+tg01/hf/zshi/PPTony/Match/track_match_${Run}_${Seg}.root
...
mv  DSTSeedSofar.root  /direct/sphenix+tg+tg01/hf/zshi/PPTony/DST/DSTSeedSofar_${Run}_${Seg}.root
mv  SeedAna_Svtx.root  /direct/sphenix+tg+tg01/hf/zshi/PPTony/Ntuple/SeedAna_Svtx_${Run}_${Seg}.root
mv  EvtAna_Svtx.root  /direct/sphenix+tg+tg01/hf/zshi/PPTony/EvtFile/EvtAna_Svtx_${Run}_${Seg}.root
mv  JobAna.root  /direct/sphenix+tg+tg01/hf/zshi/PPTony/Histo/JobAna_${Run}_${Seg}.root
