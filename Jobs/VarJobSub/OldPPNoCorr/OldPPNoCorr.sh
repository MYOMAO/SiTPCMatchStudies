...
ls *root
mv  track_match.root  /direct/sphenix+tg+tg01/hf/zshi/OldPPNoCorr/Match/track_match_${Run}_${Seg}.root
...
mv  DSTSeedSofar.root  /direct/sphenix+tg+tg01/hf/zshi/OldPPNoCorr/DST/DSTSeedSofar_${Run}_${Seg}.root
mv  SeedAna_Svtx.root  /direct/sphenix+tg+tg01/hf/zshi/OldPPNoCorr/Ntuple/SeedAna_Svtx_${Run}_${Seg}.root
mv  EvtAna_Svtx.root  /direct/sphenix+tg+tg01/hf/zshi/OldPPNoCorr/EvtFile/EvtAna_Svtx_${Run}_${Seg}.root
mv  JobAna.root  /direct/sphenix+tg+tg01/hf/zshi/OldPPNoCorr/Histo/JobAna_${Run}_${Seg}.root
